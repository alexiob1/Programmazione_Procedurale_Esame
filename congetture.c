...
{
    	/* Dichiarazione delle variabili locali alla funzione */
    	int    variab[]={0,0},      /* Input:  Array contenente i due numeri primi        	    */
               esito_lettura,	    /* Lavoro: esito della scanf 		              	    */
               acquisizione_errata, /* Lavoro: esito complessivo della scanf       	            */
               c_variab,	    /* Lavoro: contatore delle variabili dell'espressione 	    */
	       ris_a = 0,	    /* Lavoro: controllo numero primo del primo parametro           */		     
	       ris_b = 0,           /* Lavoro: controllo numero primo del secondo parametro 	    */
	       consec,		    /* Lavoro: controllo della consecutività delle variabili	    */
	...
	/* Correggere l'inserimento dei dati che finisco con 5 e verificare la consecutività */
    	{
        	do
        	{   
			esito_lettura = scanf("%d",
		        ...
		        /* Validazione stretta dei dati */	
            		acquisizione_errata = esito_lettura !=1 || variab[c_variab]<11;
			   ...
			   variab[1] > variab [0])
			{
				...
				if(ris_b != 0)
				{
					printf("Non è un numero primo consecutivo al primo inserito.\n");
					ris_b = 0;
					acquisizione_errata = 1;
				}
			}
			...
			if(ris_a == 1 &&
			   c_variab == 1 &&
			   (variab[0] == variab[1]||variab[1] < variab[0]))
			{
				printf("Hai inserito due valori uguali o il secondo è minore del primo.\n");
				acquisizione_errata = 1;			
			}
			while(getchar() !='\n');
		}
